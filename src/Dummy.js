...
import fauna9 from "./image/Forest/fauna9.png";
...
export const data = [
...

  {
    ...
    Behaviour: ["when in danger they transform themselves into a ball and roll", "when they consume food, they spin the prey around 3-5 circles", "Never alone always keep in a group of 10- 20"],
  },

  {
    ...
    Behaviour: ["When is danger they eject venomous liquid from the hanging tail", "The pointy tip of the tail can regrow once in a month time", "The point tip of the tail can spike into the prey and eject venom to paralyze their"],
  },

  {
    ...
    Behaviour: ["when in danger the little spike can automatically stretch out", "Live under the water for more than 3 hour", "Thick skin layer that spike can not penetrate through"],
  },

  {
    ...
    Behaviour: ["They can blend their skin color into the surrounding", "Their eyes can detect through the water", "They can burst flames"],
  },

  {
    ...
    Behaviour: ["Their yellow hair only grows when they have their birthday", "Feathers are waterproof", "Only hunt during night time, their red eyes provides infrared radiation"],
  },

  {
    ...
    Behaviour: ["parasites", "Only feeds on dead aliens"],
  },

  {
    ...
    Behaviour: ["Lives on dry habitat", "When in danger they turn themselves into a ball similar to porcupine"],
  },

  {
    name: "fauna1",
    imageURL: fauna1,  //Check this imageURL, it seems to be the same as fauna21
    Morophological: ["Scaly skin", "beak", "2 eyes", "4 legs"],
    Genetic_Structure: "Similar to a porcupine because of the scaly features",
    Behaviour: ["Lives on dry habitat", "When in danger they turn themselves into a ball similar to porcupine"],
  },
